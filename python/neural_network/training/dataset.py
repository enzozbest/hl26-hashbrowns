...
from neural_network.data.external import load_external_data
from neural_network.data.schema import CouncilStats, PlanningApplication
from neural_network.features.application import (
...
def _save_council_project_type_counts(
    ...
    """
    from neural_network.features.council import CouncilFeatureExtractor as _CFE
...
async def build_datasets(
    ...
    *,
    ...
    # runtime.
    from neural_network.data.regions import resolve_council_region
