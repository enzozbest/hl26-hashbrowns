...
def run_train(
    ...
    from neural_network.config.settings import Settings
    from neural_network.data.api_client import PlanningAPIClient
    from neural_network.training.train import train_model
...
def run_calibrate(
    ...
    from neural_network.model.approval_model import load_model
    from neural_network.model.calibration import TemperatureScaler
    from neural_network.training.dataset import build_dataloaders, build_datasets
    ...
    from neural_network.features.application import ApplicationFeatureExtractor
    from neural_network.features.council import CouncilFeatureExtractor
    from neural_network.features.text import TextEmbedder
    ...
    model = load_model(
        checkpoint_path,
        text_embed_dim=checkpoint.get("text_embed_dim", config.embedding_dim),
        num_app_features=checkpoint.get("num_app_features", 20),
        num_council_features=checkpoint.get("num_council_features", 8),
    )
...
def run_evaluate(
    ...
    from neural_network.model.calibration import TemperatureScaler
    from neural_network.training.dataset import build_dataloaders, build_datasets
    from neural_network.training.evaluate import evaluate_model
