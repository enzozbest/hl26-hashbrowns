...
from neural_network.inference.pipeline import InferencePipeline, PredictionResult
...
def _load_pipeline(settings: Optional[Settings] = None) -> InferencePipeline:
    ...
    from neural_network.inference.parser import ProposalParser
    from neural_network.model.approval_model import ApprovalModel, load_model
    from neural_network.model.calibration import TemperatureScaler
    from neural_network.model.council_ranker import CouncilRanker
